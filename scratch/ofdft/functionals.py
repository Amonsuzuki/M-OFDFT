...
FUNCTIONALS = {
        ...
        'LDA_K_TF': lda_k_tf_custom, 'GGA_K_VH': gga_k_vw_custom, 'GGA_K_APBE': gga_k_apbe_custom,
...
XCCODE_TO_NPZ_NAME = {
        'ZERO': 'ZERO',
        'LDA_K_TF': 'Ttf_aux_default', 'GGA_K_VH': 'Tvw_aux_default',
        'LDA_X': 'X_LDA_aux_default', 'GGA_X_B88': 'X_B88_aux_default',
        'LDA_X_VWN': 'X_VWN_aux_default', 'GGA_C_LYP': 'C_LYP_aux_default',
