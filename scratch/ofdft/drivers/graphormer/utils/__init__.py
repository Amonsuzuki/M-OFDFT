...
example spec string:
    qm9:Ts_res:orig:v1, ethanol:TsExc[atomref]:LF_alt_SVD:v1
"""
...
# least recent use, cache the last exection's result in the past. If the same exection is repeated, use it.
